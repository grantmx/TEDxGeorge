...
export const features = {
    streamingVenue: {
        ...
        included: true,
        toolTip: <ToolTip type="info" text="Watch the Main Stage livestream in HD from our overflow venues and enjoy a meal or craft while you watch." />
    },
    frontRowSeats: {
    ...
    afterParty: {
        ...
        included: true,
        toolTip: <ToolTip type="info" text="Join us for a complementary wine and tapas evening event with the speakers and sponsors directly after TEDxGeorge at the George Museum" />
    },
    mainStageTalks: {
...
export const ticketList = [
    {
        ...
        priceRaw: 249,
        allocation: 100,
        description: "Watch from a Streaming Venue",
    ...
    },
    {
        ...
        priceRaw: 799,
        allocation: 30,
        description: "Main Stage + Evening WineDown @ George Museum",
        features: Object.keys(features).map(key => {
            let included;
