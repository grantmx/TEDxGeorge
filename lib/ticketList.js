...
export const features = {
    ...
    canvasTote: {
        title: "TEDxGeorge Canvas Tote",
        included: true,
        toolTip: <ToolTip type="info" text="Get a TEDxGeorge Canvas Tote to remember the event" />
    },
    preEvent: {
    ...
    tedIgnight: {
        title: "Give a TEDxGeorge Ignite Talk",
        included: true,
        toolTip: <ToolTip type="info" text="Get a chance to give a 3 minute TEDxGeorge Ignite Talk during a TEDxGeorge Event" />
    },
    mainStageTalks: {
...
export const ticketList = [
    {
        ...
        priceRaw: 199,
        allocation: 50,
        description: "Student Level Access<br/> (18 or Older a Valid Student ID required)",
    ...
    },
    {
        ...
        priceRaw: 799,
        allocation: 100,
        description: "Main Stage Access + Free Tote",
        features: Object.keys(features).map(key => {
            let included;
