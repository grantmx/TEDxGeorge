...
import yinXiong from "@/public/speakers/yin.webp"
import laurenGouws from "@/public/speakers/lauren.webp"
import lesegoTlhabi from "@/public/speakers/Lesego.webp"
import maiaLeRoux from "@/public/speakers/mia.webp"
import romanthaBotha from "@/public/speakers/romantha.webp" 
import tashaVanDerWatt from "@/public/speakers/tasha.webp"
import jacquiChew from "@/public/speakers/jacqui.webp"
import adelePotgieter from "@/public/speakers/adele.webp"
import vandanaPremchanda from "@/public/speakers/van.webp"
import yvetteHess from "@/public/speakers/yvette.webp"
import duan from "@/public/speakers/duan.jpg"
import lorenza from "@/public/speakers/lorenza.webp"
import maja from "@/public/speakers/maja.webp"
import nikkiJackman from "@/public/speakers/NikkiJackman.webp"
import mlibo from "@/public/speakers/lilo.jpeg"


export const speakerList = {
     "maja-rey": {
        active: [ 2026 ],
        event: "TEDxGeorge Women 2026",
        first_name: "Maja",
        last_name: "Rey",
        slug: "maja-rey",
        image: maja,
        bio: `
        <p>Music has been part of my life for as long as I can remember, and it has taken me on some incredible journeys. I've had the privilege of representing South Africa at the World Championships of Performing Arts in Los Angeles on two occasions, where I was honoured to receive the Performer of the World title for my violin performances.</p>
        <p>From the age of nine, I performed as a soloist with the Johannesburg Symphony Orchestra for four consecutive years before moving to George. Since then, I've continued to pursue my passion for music while sharing it with audiences both on stage and online.</p>

        <p>I recently completed my Grade 8 in Violin, and today I create violin content for a community of over 300,000 followers across my social media platforms. My goal has always been to show that the violin is not only a classical instrument but one that can connect with people of all ages through emotion, storytelling, and creativity. I hope my journey inspires others to pursue what they love, no matter where it takes them.</p>   
        `,
        topic: "Performance",
        organization: "Violinist and Content Creator",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            tiktok: "https://www.tiktok.com/@maja_rey",
            instagram: "https://www.instagram.com/maja__rey/",
            website: "",
            linkedin: ""
        },
        talks: []
    ...
    "lorenza-allan": {
        ...
        image: lorenza,
        bio: `
            <p>Lorenza Allan is the founder of The GWEN Group—Gathering Women Entrepreneurs Network—a relationship-led business network helping women build meaningful connections, increase their visibility and create greater opportunities through community.</p>

            <p>An entrepreneur, community builder and event producer, Lorenza has worked across membership, events, content and business networking in both South Africa and the UK. Her work is grounded in a simple belief: business may be changing rapidly, but people still choose, trust and recommend people.</p>

            <p>Through GWEN, Lorenza is creating spaces where women can develop their confidence and competence, become more visible and build the relationships that help businesses grow. She is passionate about ensuring that, as the way we work and communicate continues to evolve, genuine human connection remains at the heart of business.</p>
        `,
        topic: "Brining Humanity Back to Business",
        organization: "The Gwen Group",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/thegwengroup/",
            website: "https://thegwengroup.co.za/",
            linkedin: "https://www.linkedin.com/in/thegwengroup/"
        },
        talks: []
    },
    "duan-enso": {
        ...
        image: duan,
        bio: `
            <p>The guitar in his hands becomes an orchestra all by itself, with 8 years of persistence he has been one of the few to reshape the art of guitar.</p>

            <p>He learned how to play when he was 12, and developed his passion eversince. He wasn't used to songs, covers, and still barely knows many artists.</p>

            <p>But this isolation had led him to form his own unique style with he's natural intelligence for music, a strange genre.</p>

            <p>He strives to create atmosphere, tension, and melodies to capture you in a trance of tranquility, and loves sharing he's music to make people's hearts smile.</p>
        `,
        topic: "Performance",
        organization: "Musician and Guitarist",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
    ...
    "jacqui-chew": {
        ...
        image: jacquiChew,
        bio: `
            <p>She is the Managing Director of iFusion, a consultancy that helps founders, executives, and purpose-driven organizations turn complex ideas into compelling narratives that inspire action.</p>
            <p>The firm has helped launch dozens of technology companies, creating thousands of jobs and helping founders raise more than $120 million in angel and venture capital.</p>
            <p>A strong advocate for inclusive entrepreneurship, Jacqui has been recognized by Spelman College, Georgia Tech, and the Technology Association of Georgia, and was named one of the 25 Most Influential Asian Americans in Georgia by the Georgia Asian Times.</p>
            `,
        topic: "Family & Mental Health",
        organization: "Strategist and Narrative Architect",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/jacquichew/",
            website: "https://ifusion.co/"
        },
        talks: []
    },
     "lauren-gouws": {
        ...
        image: laurenGouws,
        bio: `
            <p>Lauren Kirsty Gouws is a professional copywriter, entrepreneur, and the creator of Momapocalypse, a brand built around the honest, chaotic, and often hilarious realities of modern motherhood.</p>
            <p>With more than a decade of experience and over 19,000 projects completed for clients around the world, Lauren has built a successful copywriting career rooted in one simple belief: the most powerful stories are the honest ones. </p>
            <p>Her work helping brands find their voice has shaped the way she approaches her own storytelling as a mother.Through Momapocalypse, Lauren shares the unfiltered moments of parenting that many mothers experience but rarely say out loud.</p>
            `,
        topic: "Motherhood & Keeping Identity",
        organization: "Storyteller of Modern Motherhood",
        social: {
            facebook: "https://www.facebook.com/momapocalypse",
            twitter: "https://x.com/momapocalypse_",
            youtube: "https://www.youtube.com/@momapocalypse",
            instagram: "https://www.instagram.com/momapocalypse",
            website: "https://www.momapocalypse.com/"
        },
        talks: []
    },
    "lesego-tlhabi": {
        ...
        image: lesegoTlhabi,
        bio: `
            <p>Lesego Tlhabi is a South African comedian, writer, and performer whose work blends satire, social commentary, and cultural critique.Trained across Johannesburg, London, New York, and Paris, she brings a globally informed lens to conversations about race, identity, and power. </p>
            <p>Her work has sparked national dialogue and reached wide audiences through collaborations with brands such as Takealot, Capitec, Engen, and Canon.Lesego is also the host of "Convos & Cocktails", a platform for candid conversations among Black women.Her latest project, "With No Due Respect", uses political satire to make civic discourse more accessible, positioning comedy as a tool for public engagement.</p>
            `,
        
        topic: "Satiric Commentary on Society",
        organization: "Satirist and Social Commentator",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/lesego_tlhabi/",
            website: ""
        },
        talks: []
    },
    "nikki-jackman": {
        ...
        event: "TEDxGeorge Women 2026",
        first_name: "Nikki",
        last_name: "Jackman Joy",
        slug: "nikki-jackman",
        image: nikkiJackman,
        bio: `
            <p>“Nikki Jackman Joy” is a Southern African Story Weaver, Performance HEARTist, Impact Producer and Joy Catalyst who has spent more than two decades UPlifting the socio-emotional wellness of people with creativity and play. Her artistic accolades include being an award-winning voice artist and one of the original lead actors in Isidingo. She’s help build The Joy-Tool Box and Facilitate Joy Training, behind the UPskiling of more than 900 facilitators and upliftment of over 54,000 people across schools, hospitals, communities, businesses and stages in 5 regions of South Africa. Nikki warmly blends storytelling, creative play and practical socio-emotional wellbeing tools to grow empathy, resilience and active kindness. Her bold mission is to help people everywhere to KINDER and to facilitate more joy for themselves, others and our world.</p>
            `,
        
        topic: "On The Spot",
        organization: "The Joy Movement",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "",
            website: "https://gojoy.love/"
        },
        talks: []
    },
    "mia-le-roux": {
        ...
        image: maiaLeRoux,
        bio: `
            <p>Mia le Roux made history in 2024 as the first hearing-impaired woman to be crowned Miss South Africa, redefining perceptions of leadership, ability, and representation.Diagnosed with profound hearing loss and fitted with a cochlear implant at a young age, Mia turned adversity into purpose. </p>
            <p>Through The Mia le Roux Movement, she champions inclusion and accessibility, partnering with organisations like the Dis-Chem Foundation to fund cochlear implants and change lives.Her work extends to creating pathways into employment, supporting learnership opportunities for people with disabilities, and leading corporate sensitisation initiatives to build more inclusive workplaces. <p>
            <p>Mia's mission is clear: to ensure that difference is never a barrier to opportunity.</p>
            `,
        
        topic: "Inclusion",
        organization: "Accessibility & Inclusion Advocate",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/mialerouxx/",
            website: ""
        },
        talks: []
    },
    // "nyari-samushonga": {
    //     active: [ 2026 ],
    //     event: "TEDxGeorge 2026",
    //     first_name: "Nyari",
    //     last_name: "Samushonga",
    //     slug: "nyari-samushonga",
    //     image: nyariSamushonga,
    //     bio: `

    //         <p>Nyari Samushonga is the CEO of WeThinkCode, a South African tech academy with campuses in Johannesburg, Durban, and Cape Town. She is an entrepreneur and tech executive committed to positioning Africa as a creator of cutting-edge technology, and has driven gender parity in student recruitment within the academy. </p>
    //         <p>Under her leadership, WeThinkCode has expanded its impact by doubling recruitment capacity and launching a locally relevant curriculum tailored to the South African market.
    //         <p> A Chartered Accountant by training, Nyari previously served as Managing Director of ThoughtWorks Africa and held roles at Deloitte in Harare and New York.Born in Zimbabwe, she has lived and worked across multiple countries and is now based in Johannesburg.</p>

    //         `,
        
    //     topic: "",
    //     organization: "Technology Leader",
    //     social: {
    //         facebook: "",
    //         twitter: "https://x.com/nyarisam",
    //         youtube: "",
    //         instagram: "",
    //         website: ""
    //     },
    ...
    "romantha-botha": {
        ...
        image: romanthaBotha,
        bio: `
            <p>Romantha is a South African documentary filmmaker, journalist, and cultural commentator whose work explores the intersection of history, identity, and power. A SAFTA-nominated producer, she uses film and digital storytelling to examine how the legacies of colonialism and apartheid continue to shape the present. Her work also explores language as a living archive of resistance and memory, highlighting the role of Black and Brown voices in shaping South Africa's cultural future. </p>
            <p>Through her online platforms, she translates complex social and historical issues into accessible conversations that challenge assumptions and invite deeper reflection. Whether behind the camera, on stage, or in her community, Romantha's work is driven by a clear purpose: to confront difficult truths, reclaim cultural memory, and broaden how South Africans understand themselves and each other.</p>
            `,
        
        topic: "Cultural Advancement",
        organization: "Documentary Filmaker, Cultural Activist",
        social: {
            facebook: "https://www.facebook.com/romanthab/",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/therealroman/",
            website: ""
        },
        talks: []
    },
    "tasha-van-der-watt": {
        ...
        event: "TEDxGeorge Women 2026",
        first_name: "Tasha",
        last_name: "Van Der Watt",
        slug: "tasha-van-der-watt",
        image: tashaVanDerWatt,
        bio: `
            <p>Tasha van der Watt is a chef, entrepreneur, and storyteller rooted in the Garden Route. Born and raised in George, she began her journey in hospitality before carving her own path, from home baking to building a trusted name in cakes and, eventually, founding Beyond Flavour.</p>
            <p> Alongside her husband, she co-founded Ninas Café, where they blend restaurant dining with private cheffing, catering, and food styling. Driven by a deep love for food and people, Tasha is currently working on her first cookbook, an ode to memory, nostalgia, and the flavors that shaped her. Her work reflects a belief that food is more than nourishment; it is connection, culture, and story.</p>
            `,
        
        topic: "Food & Family History",
        organization: "Chef and Memory Weaver",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/tashavanderwatt/",
            website: "https://ninascafe.co.za/"
        },
        talks: []
    },
    "yin-xiong": {
        ...
        image: yinXiong,
        bio: `
            <p>Yin Xiong, currently living in South Africa, has been a Sacred Sound Practitioner for more than 30 years. Known as the Gong Ambassador, she has traveled globally sharing the art of gong and sound meditation.</p>
            <p> She introduced gong culture to Southern Africa in the late 1980s and later to the Middle East, becoming the first person to present gong performances and cultural programs in Saudi Arabia in 2014. A global performer and meditation practitioner, Yin presents her signature “Opera of Sounds,” immersive sound journeys known for their uplifting tonal landscapes. </p>
            <p>She is an active member of the international community of sound facilitators and has performed and lectured in many countries. Her 2024 Masterclass concert and lecture at the Portugal International Gong Camp was widely praised as a groundbreaking Gong Opera. Drawing on Eastern and Western artistic traditions, her performances demonstrate the expressive power of gong music and leave audiences with a memorable sonic experience.</p>
            `,
        
        topic: "Musical Wellness",
        organization: "Global Gong Ambassador",
        social: {
            facebook: "https://www.facebook.com/xiong.yin/",
            twitter: "",
            youtube: "",
            instagram: "",
            website: ""
    ...
    "adele-potgieter":{
        ...
        first_name: "Adele",    
        last_name: "Potgieter",
        slug: "adele-potgieter",
        image: adelePotgieter,
        bio: `
            <p>Professor Adéle Potgieter is an academic, keynote speaker, and business consultant with a strong financial background and a passion for strategic leadership, innovation, and inclusive economic development. As a professor in Marketing at Nelson Mandela University, she bridges theory and practice to empower individuals and organisations to thrive in complex environments. Adéle also leads a business coaching and consulting practice, where she works closely with entrepreneurs and small businesses to unlock growth and build sustainable ventures. Her work focuses on digital transformation, sustainability, and entrepreneurial development, with a particular heart for SMMEs and people development. Through her research, teaching, and speaking, she brings insight, authenticity, and a forward-thinking perspective on how leadership and collaboration can drive meaningful change.</p>
        `,
        topic: "Recovery & Growth",
        organization: "Stratgist, Growth Catalyst",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "",
            website: "https://apcoaching.co.za/"
        },
        talks: []
    },
    "vandana-premchand":{
        ...
        first_name: "Vandana",
        last_name: "Premchand",
        slug: "vandana-premchand",
        image: vandanaPremchanda,
        bio: `
            <p>George-based artist Vandana Premchand has been painting since early 2020. Self-taught, Vandana continues to explore the evocative and mysterious poetry of colour. Through her energetic gestures and expressive application of oil paint, Vandana guides you along sunny and battered coastlines, reveals a glimpse of a soul beneath a face, and provokes you with sensual portrayals of emotion.</p>
            <p>She is an active member of both the South Cape Association for Visual Arts and the Wilderness Art Association.</p>
            <p>Vandana's artwork has been widely exhibited in the Western Cape and has been acquired by collectors throughout the world.</p>
            <p>“I enjoy expressions of mood through paint my way. Nuanced or gutsy, I'd like my paintings to stir something deep within the observer.”</p>
        `,
        topic: "Art & Play",
        organization: "Artist and Creativity Reclaimer",
        social: {
            facebook: "",
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/bookish_van/",
            website: ""
        },
        talks: []
    },
    "yvette-hess":{
        ...
        image: yvetteHess,
        bio: `
            <p>Yvette Hess is a South African visual artist whose work explores memory, identity, and the act of meaning-making across both intimate and large-scale forms. Working across miniature painting, text, and immersive visual pieces, her practice traces how personal and collective experiences are held, fragmented, and reassembled.</p>
            <p>Her work sits at the intersection of art and healing, informed by lived encounters with altered states, psychedelics, and emotional recovery. Through both her studio practice and participatory engagements, she creates spaces where people are invited to witness, process, and translate their own stories into form.</p>
            <p>Based in the Klein Karoo, Ladismith, Yvette is part of a new generation of artists expanding the role of art as a site for reflection, connection, and transformation.</p>
        `,

        topic: "Healing in the Arts",
        organization: "Artist and Meaning-Maker",
        social: {
            facebook: "",   
            twitter: "",
            youtube: "",
            instagram: "https://www.instagram.com/yvette_hess/",
            website: ""
        },
        talks: []
    },
    "siyakhona-youth-development":{
        ...
        talks: [
            {
                title:"Siyakhona Youth Development Choir Performance",
                event:"TEDxGeorge 2025",
                video:"https://www.youtube.com/watch?v=7eglSi1dXBU",
                date: "March 2026"
            }
        ]
    },
    "shimmy-isaacs":{
        ...
        talks: [
            {
                title:"What is a Coloured South African?",
                event:"TEDxGeorge 2025",
                video:"https://www.youtube.com/watch?v=LDGkFfyEa8g",
                date: "March 2026"
            }
        ]
    },
    ...
    "rhythmical-seeds": {
        active: [ 2025 ],
        first_name: "Rhythmical",
        last_name: "Seeds, Judah Mkhambi & Chloé Swanepoel",
        slug: "rhythmical-seeds",
        image: null,
        bio: ``,
        theme: "Acrobatic Dance",
        event: "TEDxGeorge",
        ...
        talks: [
            {
                title:"TEDxGeorge Shift Dance Performance",
                event:"TEDxGeorge 2025",
                video:"https://www.youtube.com/watch?v=e3My2j2lR4k",
                date: "March 2026"
            }
        ]
    },
    ...
    "raquel-de-castro-maia": {
        ...
        social: {
            website: "https://raqueldecastromaia.com/"
        },
        talks: []
    },
    "luigi-marucchi": {
    ...
    "lorna-scott": {
        ...
        `,
        topic: null,
        theme: "Raising Neurodivergent Children",
        event: "TEDxGeorge",
