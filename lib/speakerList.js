...
export const speakerList = {
    ...
    "malaka-grant": {
        ...
        image: malaka,
        bio: `
            <p>Malaka Grant is an award‑winning author, podcaster, and cultural curator based in George, South Africa. With a degree in Mass Media Arts from Hampton University, she co‑hosts the acclaimed podcast Adventures from the Bedrooms of African Women and is the executive producer of Adventures Reads, platforms celebrating storytelling, identity, and diverse African womanhood. As CEO and Managing Director of MASI Media, Malaka leads initiatives such as the Adventures Creators Program and the Adventures Too youth project. Passionate about pleasure advocacy, media equity, mental well‑being, and Pan‑African narrative change, she also champions mentorship, mindful work cultures, and creative agency for Black women across the African diaspora.</p>
        `,
